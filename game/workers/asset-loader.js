...
export default function loadAssets() {
  return new Promise((resolve, reject) => {
    //Rabbit
    let load1 = loadAsset('Images/rabbit.png')
    .then(rabbitSheet => {
    ...
    let load2 = loadAsset('Images/chat-bubble.png')
    .then(x => {
    ...
    // Map
    let load3 = loadAsset(['Images/template1.png', 'Images/template1_collision.png'])
    .then(([map, colli]) => {
